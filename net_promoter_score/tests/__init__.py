...
# from netpromoterscore.models import UserScore
...
#         self.ps1 = UserScore(user=self.user, score=8)
#         self.ps1.save()

#         self.ps2 = UserScore(user=self.user, score=9)
#         self.ps2.save()
#         self.ps2.created_at = self.now - timedelta(4*365/12)
#         self.ps2.save()

#         self.ps3 = UserScore(user=self.user2, score=9)
#         self.ps3.save()
